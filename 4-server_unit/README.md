...
## Overview
The purpose of this document is to explain explecitely how to construct personium.io unit on 4 servers using ansible.
...
|---|---|---|---|---|
| ES + ADS_Master server | 200GB | /dev/xvdb | /opt/ads_data | MySQL data (Master) |
| ES + ADS_Master server | 200GB | /dev/xvdc | /opt/es_data-log | ES data |
| ADS_Slave server | 200GB | /dev/xvdb | /opt/ads_data | MySQL data (Slave) |
...
\* reachability testing is done, if it shows the same
 ...
 For the developers conveniency this document introduced the procedure to construct personium.io unit using ansible.
Hope developers will enjoy deploying personium.io unit on any of their suitable environment. Please try personium.io and let us know your feedback or comments for further betterment of personium.io. Your feedback and comments will be highly appreciated.
